...
export default function D3Plot({ data }) {
    ...
    useEffect(() => {
        ...
        const colorbarGroup = svg.append("g")
            .attr("transform", `translate(${margin.left + colorbarX}, ${margin.top})`);
        ...
        colorbarGroup.selectAll(".colorbar-segment")
            .data(colorbarData)
            .join("rect")
        ...
        colorbarGroup.append("text")
            .attr("transform", `translate(${colorbarWidth + 35}, ${colorbarHeight / 2}) rotate(90)`)
